...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            // Get the number of pets in Contoso Pets
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    Console.WriteLine($"{i}, {ourAnimals[i, 2]}, {ourAnimals[i, 4]}");
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        do
                        {
                            Console.WriteLine($"Enter an age for {ourAnimals[i, 0]}");
                            validEntry = int.TryParse(Console.ReadLine(), out petAge);
                            if (validEntry == true && petAge >= 0)
                            {
                    ...
                    if (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Nickname: tbd")
                    {
                        ...
                        do
                        {
                            ...
                            if (readResult != null && readResult != "")
                            {
                                ...
                                validEntry = true;
                                Console.WriteLine($"{readResult} was accepted.");
                            }
                        } while (validEntry == false);
                    }
